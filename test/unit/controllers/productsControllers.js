...
describe('PRODUCTS CONTROLLER TESTS', () => {
  ...
  //       expect(response.status.calledWith(404)).to.be.equal(true);
  //     });
  //     it('É retornado uma mensagem "Product not found"', async () => {
  //       await productsController.deleteProduct(request, response, next);
  //       expect(response.json.calledWith({ message: 'Product not found' })).to.be.equal(true);
  //     });
  //   });
  ...
  //       await productsController.deleteProduct(request, response, next);
  //       expect(response.status.calledWith(204)).to.be.equals(true);
  //     });
  //     it('Não é retornado nenhuma mensagem', async () => {
  //       await productsController.deleteProduct(request, response, next);
  //       expect(response.end).to.be.equal(true);
  //     });
  //   });
  // });
});
